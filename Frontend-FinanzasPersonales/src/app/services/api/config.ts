...
export const ENDPOINTS = {
  ...
  resetPassword: ensureLeadingSlash(import.meta.env.VITE_API_RESET_PASSWORD_ENDPOINT ?? "/auth/reset-password"),
  ...
  updateProfile: ensureLeadingSlash(import.meta.env.VITE_API_UPDATE_PROFILE_ENDPOINT ?? "/auth/profile"),
